...
func (x *RepositoryBranch) GetLastUpdateGitAuthorName() string {
	if x != nil {
		return x.LastUpdateGitAuthorName
	}
	return ""
}
...
func (x *RepositoryBranch) GetLastUpdateGitCommitHash() string {
	if x != nil {
		return x.LastUpdateGitCommitHash
	}
	return ""
}
...
var file_buf_alpha_registry_v1alpha1_repository_branch_proto_rawDesc = []byte{
	...
	0x22, 0x03, 0x90, 0x02, 0x01, 0x42, 0x91, 0x02, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x62, 0x75,
	...
	0x72, 0x69, 0x6b, 0x72, 0x73, 0x6e, 0x61, 0x2d, 0x62, 0x75, 0x66, 0x2f, 0x73, 0x64, 0x6b, 0x2f,
